                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h3 class="card-title">Add Flat Rent</h3>

                        </div>


                        <form role="form" id="quickForm" method="post" action="add_flatrent.php">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputWeightUnit">Select Apartment</label>
                                    <select class="form-control" name="apartment_id">
                                        <option disabled selected hidden>Select Apartment</option>
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            echo "<option value='" . $row['apartment_id'] . "'>" . $row['apartment_no'] . "</option>";
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" id="add_flatrent" class="btn btn-primary"><i class="fa fa-check-circle"></i> Add Flat Rent</button>
                            </div>
                        </form>
