...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $result = mysqli_query($con, "SELECT * FROM guards WHERE nid='$nid'");
  ...
  if ($num_rows > 0) {
    ...
    if (mysqli_query($con, "INSERT INTO guards (`name`,`phone`,`address`,`nid`) VALUE ('$name','$phone','$address','$nid')")) {
      echo '<script type="text/javascript">';
...
<head>
  ...
  <title>Add Security Guards</title>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <h3 class="card-title">Add Secrity Guards Information</h3>

            </div>


            <form role="form" id="quickForm" method="post" action="add_guards.php">
              <div class="card-body">
              ...
              <div class="card-footer">
                ...
                <button type="submit" id="add_guards" class="btn btn-primary"><i class="fa fa-check-circle"></i> Add
                  Security Guard
                </button>
              </div>
            </form>
...
<script type="text/javascript">
  ...
  $(document).on('click', '#add_guards', function (e) {
