                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button type="button" onclick="location.href = 'add_apartments.php';"
                                    class="btn btn-primary float-right">
                                <i class='fas fa-plus-circle'></i> Add Apartments
                            </button>
                            <h3 class="card-title">All apartment list</h3>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    if ($user_type == 'admin') {
                                        ...
                                        echo "<td><a class='btn btn-primary'  href=\"edit_apartment.php?id=" . $row['apartment_id'] . "\" ><i class='fas fa-edit'></i></a>  ";
                                        echo "<a class='confirmation btn btn-danger'  href=\"delete_apartment.php?id=" . $row['apartment_id'] . "\" ><i class='fas fa-trash'></i></a></td>";
                                    }
