...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = mysqli_query($con, "UPDATE expense_category SET category_name='$category_name' WHERE category_id='$category_id'");
            ...
            <form role="form" id="quickForm" method="post" action="edit_category.php">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="category_id" class="form-control" id="exampleInputCustomerName"
                         value="<?php echo $row['category_id'] ?>">
                </div>

                <div class="form-group">
                  <label for="exampleInputCategoryName">Expense Category Name</label>
                  <input type="text" name="category_name" class="form-control" id="exampleInputCategoryName"
