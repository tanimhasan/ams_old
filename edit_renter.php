...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
  ...
  if (!empty($getid)) {
    $query = mysqli_query($con, "SELECT * FROM renters WHERE renter_id='$getid'");
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="renters.php" class="nav-link active">
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <h3 class="card-title">Update renters information</h3>

            </div>


            <form role="form" id="quickForm" method="post" action="edit_renter.php">
              <div class="card-body">

                <div class="form-group">

                  <input type="hidden" name="renter_id" class="form-control" id="exampleInputrenterName"
                         value="<?php echo $row['renter_id'] ?>">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="email" name="renter_email" class="form-control" id="exampleInputEmail1" readonly
                         value="<?php echo $row['renter_email'] ?>">
                </div>


                <div class="form-group">
                  <label for="exampleInputPhone">Phone Number <small>[Not Editable]</small> </label>
                  <input type="tel" name="renter_phone" class="form-control" id="exampleInputPhone" readonly
                         value="<?php echo $row['renter_phone'] ?>">
                </div>

                <div class="form-group">
                  <label for="exampleInputPhone">ID / NID Number <small>[Not Editable]</small> </label>
                  <input type="tel" name="renter_nid" class="form-control" id="exampleInputPhone" readonly
                         value="<?php echo $row['renter_nid'] ?>">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="renter_address" class="form-control" id="exampleInputAddress"
                         value="<?php echo $row['renter_address'] ?>">
                </div>
