                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                $sql = "SELECT * FROM expense_category ORDER BY category_id DESC";
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    if ($user_type == 'admin') {
                                        ...
                                        echo "<td><a class='btn btn-primary'  href=\"edit_category.php?id=" . $row['category_id'] . "\" ><i class='fas fa-edit'></i></a>  ";
                                        echo "<a class='confirmation btn btn-danger'  href=\"delete_category.php?id=" . $row['category_id'] . "\" ><i class='fas fa-trash'></i></a></td>";
                                    }
