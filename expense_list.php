                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                $sql = "SELECT expense_category.category_name, expense.expense_name, expense.expense_note, expense.expense_amount, expense.expense_time, expense.expense_date, expense.expense_id
FROM expense
INNER JOIN expense_category
ON expense_category.category_id=expense.category_id";
