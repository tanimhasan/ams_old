                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    $total_price = floatval($row['order_price']) + floatval($row['tax']) - floatval($row['discount']);

                                    echo "<td>" . $i . "</td>";
                                    echo "<td>" . $row['customer_name'] . "</td>";

                                    echo "<td> <a class='btn btn-primary'  href=\"orders_details.php?id=" . $row['invoice_id'] . "\" >" . $row['invoice_id'] . "</a>  ";
                                    echo "<td>" . $row['order_type'] . "</td>";
                                    echo "<td>" . $currency . $total_price . "</td>";
                                    echo "<td>" . $row['order_payment_method'] . "</td>";
                                    echo "<td>" . $row['order_time'] . "," . date('d F, Y', strtotime($row['order_date'])) . "</td>";

                                    echo "<td>" . $row['served_by'] . "</td>";

                                    echo "<td><a class='btn btn-primary'  href=\"invoice.php?id=" . $row['invoice_id'] . "\" target='_blank'><i class='fas fa-receipt'></i></a> </td> ";
                                    if ($user_type == 'admin') {
