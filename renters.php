                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button type="button" onclick="location.href = 'add_renters.php';"
                                    class="btn btn-primary float-right"><i class='fas fa-plus-circle'></i> Add Renter
                            </button>
                            <h3 class="card-title">All renters information</h3>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                $sql = "SELECT * FROM renters ORDER BY renter_id DESC";
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<td>" . $row['renter_nid'] . "</td>";
                                    echo "<td>" . $row['renter_address'] . "</td>";

                                    if ($user_type == 'admin') {

                                        echo "<td><a class='btn btn-primary'  href=\"edit_renter.php?id=" . $row['renter_id'] . "\" ><i class='fas fa-edit'></i></a>  ";
                                        echo "<a class='confirmation btn btn-danger'  href=\"delete_renter.php?id=" . $row['renter_id'] . "\" ><i class='fas fa-trash'></i></a></td>";
                                    }
