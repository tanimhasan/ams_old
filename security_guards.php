                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button type="button" onclick="location.href = 'add_guards.php';"
                                    class="btn btn-primary float-right">
                                <i class='fas fa-plus-circle'></i> Add Security Guards
                            </button>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                $sql = "SELECT * FROM guards ORDER BY sg_id DESC";
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    if ($user_type == 'admin') {
                                        ...
                                        echo "<td><a class='btn btn-primary'  href=\"edit_guards.php?id=" . $row['sg_id'] . "\" ><i class='fas fa-edit'></i></a>  ";
                                        echo "<a class='confirmation btn btn-danger'  href=\"delete_guards.php?id=" . $row['sg_id'] . "\" ><i class='fas fa-trash'></i></a></td>";
                                    }
